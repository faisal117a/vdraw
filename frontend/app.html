...
<head>
    ...
    <title>VDraw | Descriptive Statistics</title>
...
<body class="h-screen flex overflow-hidden text-slate-100">
    ...
    <!-- Sidebar -->
    <aside id="sidebar"
        class="fixed md:relative top-0 left-0 h-full w-80 bg-slate-900 border-r border-slate-800 flex flex-col z-30 shadow-2xl transform -translate-x-full md:translate-x-0 transition-transform duration-300">
        <!-- Logo -->
        <div class="p-6 border-b border-slate-800 flex justify-between items-center">
            <div>
                <h1
                    class="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-brand-400 to-purple-500">
                    <i class="fa-solid fa-chart-simple mr-2 text-brand-500"></i>VDraw
                </h1>
                <p class="text-slate-500 text-xs mt-1 uppercase tracking-wider">Statistical Analysis</p>
            </div>
            <!-- Close Button (Mobile) -->
    ...
    <main class="flex-1 flex flex-col relative overflow-hidden transition-all duration-300">
        ...
        <header
            ...
            <div class="flex items-center space-x-2 md:space-x-4 overflow-hidden justify-end flex-1 pl-2">
                <!-- Module Switcher -->
                <div
                    class="flex items-center bg-slate-800 rounded-lg p-1 border border-slate-700 overflow-x-auto scrollbar-hide shrink-0 max-w-[160px] sm:max-w-none">
                    <button id="nav-vdraw"
                        class="px-2 md:px-3 py-1 text-[10px] md:text-xs font-bold rounded text-white bg-brand-600 shadow transition-all whitespace-nowrap">
                        Stats
                    </button>
                    <button id="nav-pdraw"
                        class="px-2 md:px-3 py-1 text-[10px] md:text-xs font-bold rounded text-slate-400 hover:text-white hover:bg-slate-700 transition-all whitespace-nowrap">
                        Linear
                    </button>
                    <button id="nav-tgdraw"
                        class="px-2 md:px-3 py-1 text-[10px] md:text-xs font-bold rounded text-slate-400 hover:text-white hover:bg-slate-700 transition-all whitespace-nowrap">
                        Graph
                    </button>
                </div>
                ...
                <button id="theme-toggle"
                    class="h-7 w-7 md:h-8 md:w-8 rounded-full bg-slate-700 hover:bg-slate-600 flex items-center justify-center text-slate-300 transition-colors shrink-0">
                    <i class="fa-solid fa-sun text-xs md:text-sm"></i>
                </button>
        ...
        <div class="flex-1 overflow-y-auto p-8 relative">
            ...
            <div id="pdraw-dashboard" class="hidden transition-opacity duration-300 h-full flex flex-col">
                ...
                <div class="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 h-full overflow-y-auto lg:overflow-hidden">
                    ...
                    <div class="lg:col-span-3 glass-panel rounded-xl p-4 flex flex-col space-y-4">
                        <div class="border-b border-slate-700 pb-2">
                            <h3 class="text-sm font-bold text-green-400 uppercase tracking-wider">Data Structure</h3>
                        </div>
                        ...
                        <!-- Op List -->
                        <div
                            class="flex-1 overflow-y-auto bg-slate-900/50 rounded-lg p-2 border border-slate-800 min-h-[150px]">
                        ...
                        <button id="pdraw-simulate"
                            class="w-full py-3 bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-500 hover:to-teal-500 text-white font-bold rounded-lg shadow-lg">
    ...
    <script src="js/tgdraw/tgdraw.js"></script>
</body>
