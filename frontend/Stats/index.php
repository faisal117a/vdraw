        ...
        <div class="flex-1 overflow-y-auto p-4 space-y-6 scrollbar-thin scrollbar-thumb-slate-700">
            ...
            <div class="space-y-3">
                ...
                <div class="grid grid-cols-2 gap-2 bg-slate-800 p-1 rounded-lg">
                    <button id="btn-manual" class="px-3 py-2 text-sm font-medium rounded-md bg-brand-600 text-white shadow-lg transition-all">Manual</button>
                    <button id="btn-upload" class="px-3 py-2 text-sm font-medium rounded-md text-slate-400 hover:text-white hover:bg-slate-700 transition-all">Upload</button>
                </div>
                <!-- Manual Input Area -->
        ...
        <header class="h-16 border-b border-slate-800/50 flex items-center justify-between px-3 md:px-8 glass-panel z-10 transition-colors duration-300">
            <div class="flex items-center shrink-0">
             ...
             <div class="flex items-center space-x-2 md:space-x-4 overflow-hidden justify-end flex-1 pl-2">
                 <!-- No module switcher for standalone Stats App -->
                 
                 <!-- Theme Toggle -->
                <button id="theme-toggle" class="h-7 w-7 md:h-8 md:w-8 rounded-full bg-slate-700 hover:bg-slate-600 flex items-center justify-center text-slate-300 transition-colors shrink-0">
        ...
        <div class="flex-1 overflow-y-auto p-8 relative">
            ...
            <div id="vdraw-dashboard" class="transition-opacity duration-300">
                ...
                <div id="empty-state" class="flex flex-col items-center justify-center h-[60vh] text-center">
                    ...
                    <p class="text-slate-500 max-w-md">Enter data manually or upload a file on the sidebar to generate descriptive statistics and visualizations.</p>
                </div>
