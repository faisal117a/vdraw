        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm text-slate-400">
                ...
                <tbody class="divide-y divide-slate-800" id="ads-table-body">
                    <tr>
                        <td colspan="6" class="p-8 text-center italic">Loading ads...</td>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <div class="border-t border-slate-800 pt-4">
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-3 gap-2 text-xs bg-slate-950 p-2 rounded border border-slate-800">
                        ...
                        <label class="flex items-center gap-2"><input type="checkbox" name="apps[]" value="algoviz" checked> AlgoViz</label>
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="grid grid-cols-2 gap-2 text-xs bg-slate-950 p-2 rounded border border-slate-800 h-32 overflow-y-auto">
                        ...
                        <label class="flex items-center gap-2"><input type="checkbox" name="placements[]" value="algoviz_intro_bottom"> AlgoViz: Bottom</label>
                    </div>
                </div>
...
<script>
    ...
    async function loadAdsList() {
        ...
        try {
            const res = await fetch(ADS_MANAGER_URL, {
                method: 'POST',
                body: fd
            });
