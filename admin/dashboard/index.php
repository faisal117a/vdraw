...
$chartLabels = []; $chartData = []; $chartCost = [];
...
<body class="h-screen flex overflow-hidden bg-slate-950">
    ...
    <main class="flex-1 overflow-y-auto p-4 md:p-8 relative">
        ...
        <div class="max-w-7xl mx-auto">
                    ...
                    <div class="glass-panel p-6 rounded-xl border border-slate-700 max-h-[200px] overflow-y-auto custom-scrollbar">
                         ...
                         <table class="w-full text-xs text-slate-400">
                             <tbody>
                                 ...
                                 <?php endforeach; ?>
                                 <?php if(empty($topCountries)): ?><tr><td colspan="2" class="py-2 italic">No country data.</td></tr><?php endif; ?>
                             </tbody>
                         </table>
                         </div>
                    </div>
                    ...
                    <div class="glass-panel p-6 rounded-xl border border-slate-700 max-h-[200px] overflow-y-auto custom-scrollbar">
                         ...
                         <table class="w-full text-xs text-slate-400">
                             <tbody>
                                 ...
                                 <?php endforeach; ?>
                                 <?php if(empty($topIPs)): ?><tr><td colspan="3" class="py-2 italic">No IP data.</td></tr><?php endif; ?>
                             </tbody>
                         </table>
                         </div>
                    </div>
                          ...
                          options: {
                              ...
                              scales: { 
                                  y: { 
                                      ...
                                      ticks: { color: '#94a3b8' },
                                      title: { display: true, text: 'Tokens', color: '#64748b' }
                                  }, 
                                  y1: { 
                                      beginAtZero: true, 
                                      position: 'right',
                                      grid: { drawOnChartArea: false }, 
                                      ticks: { color: '#22c55e', callback: (val) => '$' + val },
                                      title: { display: true, text: 'Cost', color: '#22c55e' }
                                  },
            ...
            <div id="tab-users" class="tab-content hidden">
                ...
                if($s_role) { $where[] = "u.role = ?"; $params[] = $s_role; $types .= "s"; }
                if($s_status) { $where[] = "u.status = ?"; $params[] = $s_status; $types .= "s"; }
                if($s_email) { $where[] = "u.email LIKE ?"; $params[] = "%$s_email%"; $types .= "s"; }
                if($s_date_start) { $where[] = "DATE(u.created_at) >= ?"; $params[] = $s_date_start; $types .= "s"; }
                if($s_date_end) { $where[] = "DATE(u.created_at) <= ?"; $params[] = $s_date_end; $types .= "s"; }
                ...
                $users = [];
                $curDay = date('Ymd'); $curMonth = date('Ym');
                $q = "SELECT u.*, 
                ...
                <div class="glass-panel rounded-xl overflow-hidden">
                    ...
                    <table class="w-full text-left text-sm text-slate-400">
                        ...
                        <tbody class="divide-y divide-slate-800">
                            ...
                            <?php endforeach; ?>
                            <?php if(empty($users)): ?>
                                <tr><td colspan="4" class="px-6 py-8 text-center text-slate-500 italic">No users found matching filters.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                    </div>
                 ...
                 <div class="glass-panel rounded-xl overflow-hidden mb-8">
                    ...
                    <table class="w-full text-left text-sm text-slate-400">
                        ...
                        <tbody class="divide-y divide-slate-800">
                            ...
                            <tr><td colspan="4" class="px-6 py-4 text-center italic text-slate-600">No pending requests.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
                        ...
                        <div class="md:col-span-2 glass-panel rounded-xl overflow-hidden">
                            ...
                            <table class="w-full text-left text-sm text-slate-400">
                                ...
                                <tbody class="divide-y divide-slate-800">
                                    ...
                                    <tr><td colspan="4" class="px-6 py-4 text-center italic text-slate-600">No IPs blocked.</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="glass-panel w-full max-w-4xl p-6 rounded-xl relative h-[80vh] flex flex-col bg-slate-900">
            ...
            <div id="log-content-activity" class="flex-1 overflow-y-auto custom-scrollbar">
                 <table class="w-full text-left text-xs text-slate-400">
                     <thead class="bg-slate-800 text-slate-200 sticky top-0"><tr><th class="p-2">Time</th><th class="p-2">Type</th><th class="p-2">Description</th><th class="p-2">IP</th><th class="p-2">Country</th></tr></thead>
            ...
            <div id="tab-reports" class="tab-content hidden">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                        ...
                        <div class="glass-panel p-6 rounded-xl border border-slate-700">
                            ...
                            <div class="max-h-[250px] overflow-y-auto custom-scrollbar">
                               <table class="w-full text-xs text-slate-400">
                                   <thead class="bg-slate-800 text-slate-200 uppercase sticky top-0"><tr><th class="p-2">Country</th><th class="p-2">Tokens</th><th class="p-2">Cost</th></tr></thead>
                                   <tbody id="rep-geo-body" class="divide-y divide-slate-800"><tr><td colspan="3" class="p-4 text-center">Loading...</td></tr></tbody>
                               </table>
                            </div>
                        </div>
                        <!-- IP Report -->
                        <div class="glass-panel p-6 rounded-xl border border-slate-700">
                            ...
                            <div class="max-h-[250px] overflow-y-auto custom-scrollbar">
                                <table class="w-full text-xs text-slate-400">
                                   <thead class="bg-slate-800 text-slate-200 uppercase sticky top-0"><tr><th class="p-2">IP</th><th class="p-2">Reqs</th><th class="p-2">Toks</th><th class="p-2">Cost</th></tr></thead>
                                   <tbody id="rep-ip-body" class="divide-y divide-slate-800"><tr><td colspan="3" class="p-4 text-center">Loading...</td></tr></tbody>
                               </table>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-xs text-slate-400">
                            ...
                            <tbody id="rep-table-body" class="divide-y divide-slate-800">
                                <tr><td colspan="7" class="p-4 text-center italic">Loading...</td></tr>
                            </tbody>
                ...
                <div id="report-subtab-overview" class="hidden">
                        ...
                        <div class="max-h-[300px] overflow-auto custom-scrollbar">
                           <table class="w-full text-xs text-slate-400">
                               ...
                               <tbody id="rep-trends-body" class="divide-y divide-slate-800">
                                    <tr><td colspan="7" class="p-4 text-center">Loading trends...</td></tr>
                               </tbody>
                           </table>
                        </div>
                    </div>
                         ...
                         <div class="glass-panel p-6 rounded-xl border border-slate-700">
                             ...
                             <div class="max-h-[300px] overflow-auto custom-scrollbar">
                                 <table class="w-full text-xs text-slate-400">
                                     ...
                                     <tbody id="rep-buttons-body" class="divide-y divide-slate-800"><tr><td colspan="3" class="p-4 text-center">Loading...</td></tr></tbody>
                                 </table>
                             </div>
                         </div>
                         ...
                         <div class="glass-panel p-6 rounded-xl border border-slate-700 flex flex-col gap-4">
                             ...
                             <div class="flex-1 overflow-hidden flex flex-col">
                                 ...
                                 <div class="overflow-auto custom-scrollbar flex-1">
                                     <table class="w-full text-xs text-slate-400">
                                         <thead class="bg-slate-800 text-slate-200 uppercase sticky top-0">
                                             <tr><th class="p-2 text-left">Title</th><th class="p-2 text-right">Opens</th></tr>
                                         </thead>
                                         <tbody id="rep-doc-top" class="divide-y divide-slate-800">
                                             <tr><td colspan="2" class="p-2 text-center">Loading...</td></tr>
                                         </tbody>
                                     </table>
                                 </div>
                             </div>
                         ...
                         <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                             ...
                             <div>
                                  ...
                                  <div class="overflow-y-auto max-h-[150px] custom-scrollbar">
                                      <table class="w-full text-xs text-slate-400">
                                          <thead class="bg-slate-800 text-slate-200"><tr><th class="p-2 text-left">User</th><th class="p-2 text-right">Points</th></tr></thead>
                                          <tbody id="rep-top-earners" class="divide-y divide-slate-800"><tr><td colspan="2" class="p-2 italic text-center">Loading...</td></tr></tbody>
                                      </table>
                                  </div>
                             </div>
                         </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                         ...
                         <div class="glass-panel p-6 rounded-xl border border-slate-700">
                             ...
                             <div class="max-h-[250px] overflow-y-auto custom-scrollbar">
                                <table class="w-full text-xs text-slate-400">
                                   <thead class="bg-slate-800 text-slate-200 uppercase sticky top-0"><tr><th class="p-2">App</th><th class="p-2">Country</th><th class="p-2 text-right">Visits</th></tr></thead>
                                   <tbody id="rep-country-body" class="divide-y divide-slate-800"><tr><td colspan="3" class="p-4 text-center">Loading...</td></tr></tbody>
                                </table>
                             </div>
                         </div>
                         <!-- OS Stats -->
                         <div class="glass-panel p-6 rounded-xl border border-slate-700">
                             ...
                             <div class="max-h-[250px] overflow-y-auto custom-scrollbar">
                                <table class="w-full text-xs text-slate-400">
                                   <thead class="bg-slate-800 text-slate-200 uppercase sticky top-0"><tr><th class="p-2">App</th><th class="p-2">OS</th><th class="p-2 text-right">Visits</th></tr></thead>
                                   <tbody id="rep-os-body" class="divide-y divide-slate-800"><tr><td colspan="3" class="p-4 text-center">Loading...</td></tr></tbody>
                                </table>
                             </div>
                         </div>
                    </div>
                ...
                <script>
                    ...
                    async function loadAppMetrics(appName, preserveDates = false) {
                        ...
                        try {
                            const res = await fetch('user_actions.php', { method: 'POST', body: fd });
    ...
    <script>
        ...
        async function loadReportData(page = 1) {
            ...
            try {
                ...
                if(d.status === 'success') {
                    ...
                    const safeUpdate = (fn) => { try { fn(); } catch(e) { console.error('Report Update Error:', e); } };
                    ...
                    // 5. Rankings
                    safeUpdate(() => {
                        const rn = d.stats.rankings || {daily:[], weekly:[], monthly:[]};
            ...
            } catch(e) { console.error(e); alert('Reports Load Failed: ' + e.message); }
        }
        ...
        async function performSecurityAction(action, ip) {
            ...
            fd.append('ip', ip);
            try {
                const res = await fetch('security_actions.php', { method: 'POST', body: fd });
